...
Arena::Arena(int nRows, int nCols)
	: m_history(nRows, nCols) //allows me to bypass lack of default constructor
{
...
bool Arena::attackZombieAt(int r, int c, int dir)
{
	...
	{
		//m_history.record(r,c);	//arena's history object must be notified about position where it died
		delete m_zombies[k];
